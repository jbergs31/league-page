...
export const managers = [
      {
        ...
        "photo": "/static/managers/Logan.jpg", // square ratio recommended (no larger than 500x500)
        ...
        "rival": {
          ...
          image: "Logan.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
        },
      ...
      },
      {
        ...
        "location": "Murray Hill, NYC", // (optional)
        "bio": "Eth",
        "photo": "Logan", // square ratio recommended (no larger than 500x500)
        "fantasyStart": 2015, // (optional) when did the manager start playing fantasy football
        "favoriteTeam": "nyg", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
        "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
        "rival": {
